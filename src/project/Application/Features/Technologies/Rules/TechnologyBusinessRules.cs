...
namespace Application.Features.Technologies.Rules
{
    public class TechnologyBusinessRules
    {
        ...
        public async Task TechnologyMustExist(int id)
        {
            IPaginate<Technology> result = await _technologyRepository.GetListAsync(p=>p.Id == id);
            if (!result.Items.Any()) throw new BusinessException("Technology does not exist.");
